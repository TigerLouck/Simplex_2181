...
{
	m_uShaderProgramID = LoadShaders("Shaders//CompColor.vs", "Shaders//CompColor.fs");
...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	if (a_event.key.code == sf::Keyboard::Key::Escape)//Event says I pressed the Escape key
		...
		m_f1CompCoeff = glm::float1(1.0 - m_f1CompCoeff);
}
void AppClass::Display(void)
{
	...
	GLuint ComplementaryCoeff = glGetUniformLocation(m_uShaderProgramID, "ComplementaryCoeff");
	glUniform1f(ComplementaryCoeff, m_f1CompCoeff);
